  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-semibold tracking-tight text-white">Sign in to Lucid Docs</h1>
        <p className="text-lg text-gray-400">Continue writing better API documentation</p>
      </div>
      ...
      <form action={formAction} className="space-y-6">
        ...
        <div className="text-center text-gray-400">
          ...
          <Link href="/auth/sign-up" className="text-white hover:underline">
            Create your Lucid Docs account
          </Link>
        </div>
      </form>
    </div>
